    ...
    <section id="certifications" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent mb-4">
            Certifications
          </h2>
            ...
            >
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg sm:text-xl font-bold text-white mb-2 group-hover:text-cyan-400 break-words">
                    {cert.title}
                  </h3>
